    ...
    internal class Program
    {
        ...
        static void ArchivoTXTyCSV(string filePath)
        {
            ...
            if (lines.Length >= 0)
            {
                ...
                Console.WriteLine($"Primera línea: {no_estados}");
                Console.WriteLine($"Segunda línea: {estado_inicial}");
                Console.WriteLine($"Tercera línea: {estado_final}");
        ...
        static void ArchivoJSON(string filePath)
        {
            ...
            estado_final = jsonObject["estado_final"].Value<string>();
            ...
            for (int i = 0; i < filas; i++)
            {
                ...
                datos[i, 0] = (int)filaDatos[0];
                datos[i, 1] = (int)filaDatos[1];
                datos[i, 2] = (int)filaDatos[2];
            }
